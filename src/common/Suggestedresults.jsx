  ...
  return (
    <div className="Suggestedresults">
      ...
      <div className="Suggestedresults_content">
        <h4>{locale === "en" ? "Suggested for you" : "نتائج مقترحة"} </h4>
        <div className="d-flex">
          <Link href={`/${locale}/apartment?operation=rent`}>
            {locale === "en" ? "Properties for rent" : "عقارات للأيجار"}
          </Link>
          <Link
            href={`/${locale}/apartment?operation=rent&propertyType=apartment&bedrooms=1`}
          >
            {locale === "en"
          ...
          <Link
            href={`/${locale}/apartment?operation=rent&propertyType=apartment&bedrooms=2`}
          >
            {locale === "en"
          ...
          <Link
            href={`/${locale}/apartment?operation=rent&propertyType=apartment&bedrooms=3`}
          >
            {locale === "en"
          ...
          <Link
            href={`/${locale}/apartment?operation=rent&propertyType=apartment&bedrooms=4`}
          >
            {locale === "en"
              ? "4 bedroom apartment for rent in Egypt"
              : "عقارات شقة 4 غرفة للايجار نوم في مصر"}
          </Link>
          <Link href={`/${locale}/apartment?operation=rent&propertyType=villa`}>
            {locale === "en"
              ? "Villa properties for rent"
              : "عقارات فيلا للأيجار"}
          </Link>
          <Link
            href={`/${locale}/apartment?operation=rent&propertyType=duplex`}
          >
            {locale === "en"
